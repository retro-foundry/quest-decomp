...
COPYBLOCK room_cell_map_alignment_source, room_cell_map_alignment_source_end, room_cell_map_alignment+HIGH_RUNTIME_TO_LOADED_DELTA
...
COPYBLOCK room_cell_map_source, room_cell_map_source_end, room_cell_map+HIGH_RUNTIME_TO_LOADED_DELTA
...
COPYBLOCK process_player_cell_interactions_source, process_player_cell_interactions_source_end, process_player_cell_interactions+HIGH_RUNTIME_TO_LOADED_DELTA
...
COPYBLOCK room_render_state_source, room_render_state_source_end, room_moving_object_graphic_state+HIGH_RUNTIME_TO_LOADED_DELTA
...
ASSERT effect_room_appearance_indices_source_end = start_saved_display_block_shift_effect
...
COPYBLOCK terminal_activation_records_source, terminal_activation_records_source_end, terminal_activation_records+HIGH_RUNTIME_TO_LOADED_DELTA
...
COPYBLOCK status_panel_alignment_padding_source, status_panel_alignment_padding_source_end, status_panel_alignment_padding+HIGH_RUNTIME_TO_LOADED_DELTA
...
COPYBLOCK warp_entry_alignment_nop_source, warp_entry_alignment_nop_source_end, warp_entry_alignment_nop+HIGH_RUNTIME_TO_LOADED_DELTA
...
COPYBLOCK item_restore_alignment_nop_source, item_restore_alignment_nop_source_end, item_restore_alignment_nop+HIGH_RUNTIME_TO_LOADED_DELTA
...
COPYBLOCK inline_printer_alignment_padding_source, inline_printer_alignment_padding_source_end, inline_printer_alignment_padding+HIGH_RUNTIME_TO_LOADED_DELTA
...
COPYBLOCK initial_sound_parameter_block_source, initial_sound_parameter_block_source_end, sound_block_channel+HIGH_RUNTIME_TO_LOADED_DELTA
...
ASSERT music_tune_progress_source_end = enter_submit_osword_07_sound_block
COPYBLOCK music_tune_progress_source, music_tune_progress_source_end, music_tune_progress+HIGH_RUNTIME_TO_LOADED_DELTA
...
COPYBLOCK apply_player_energy_delta_to_budget_source, apply_player_energy_delta_to_budget_source_end, apply_player_energy_delta_to_budget+HIGH_RUNTIME_TO_LOADED_DELTA
...
COPYBLOCK room_entity_and_effect_state_source, room_entity_and_effect_state_source_end, room_moving_object_graphic_state_block+HIGH_RUNTIME_TO_LOADED_DELTA
...
COPYBLOCK terminal_interaction_text_stream_source, terminal_interaction_text_stream_source_end, terminal_interaction_text_stream+HIGH_RUNTIME_TO_LOADED_DELTA
...
COPYBLOCK terminal_interaction_text_padding_source, terminal_interaction_text_padding_source_end, terminal_interaction_text_padding+HIGH_RUNTIME_TO_LOADED_DELTA
...
COPYBLOCK draw_fixed_pair_tile_run_source, draw_fixed_pair_tile_run_source_end, draw_fixed_pair_tile_run+HIGH_RUNTIME_TO_LOADED_DELTA
...
COPYBLOCK draw_bordered_horizontal_bar_row_source, draw_bordered_horizontal_bar_row_source_end, draw_bordered_horizontal_bar_row+HIGH_RUNTIME_TO_LOADED_DELTA
...
COPYBLOCK right_half_four_tile_graphic_sequences_source, right_half_four_tile_graphic_sequences_source_end, right_half_four_tile_graphic_sequences+HIGH_RUNTIME_TO_LOADED_DELTA
...
COPYBLOCK save_display_pointer_and_cell_reference_source, save_display_pointer_and_cell_reference_source_end, save_display_pointer_and_cell_reference+HIGH_RUNTIME_TO_LOADED_DELTA
...
COPYBLOCK update_and_draw_two_cross_room_robot_ghosts_source, update_and_draw_two_cross_room_robot_ghosts_source_end, update_and_draw_two_cross_room_robot_ghosts+HIGH_RUNTIME_TO_LOADED_DELTA
...
COPYBLOCK draw_state_selected_narrow_bar_center_row_source, draw_state_selected_narrow_bar_center_row_source_end, draw_state_selected_narrow_bar_center_row+HIGH_RUNTIME_TO_LOADED_DELTA
...
ASSERT draw_narrow_bar_beam_pattern_row_source_end = draw_left_half_sequence_twice_or_narrow_bar_beam_pattern
...
COPYBLOCK advance_cross_room_robot_ghost_offset_and_display_pointer_source, advance_cross_room_robot_ghost_offset_and_display_pointer_source_end, advance_cross_room_robot_ghost_offset_and_display_pointer+HIGH_RUNTIME_TO_LOADED_DELTA
...
COPYBLOCK left_half_four_tile_graphic_sequences_source, left_half_four_tile_graphic_sequences_source_end, left_half_four_tile_graphic_sequences+HIGH_RUNTIME_TO_LOADED_DELTA
...
COPYBLOCK draw_narrow_bar_beam_pattern_row_source, draw_left_half_sequence_twice_or_narrow_bar_beam_pattern_source_end, draw_narrow_bar_beam_pattern_row+HIGH_RUNTIME_TO_LOADED_DELTA
CLEAR draw_narrow_bar_beam_pattern_row_source, draw_left_half_sequence_twice_or_narrow_bar_beam_pattern_source_end
COPYBLOCK draw_room_sign_or_collect_password_source, draw_room_sign_or_collect_password_source_end, draw_room_sign_or_collect_password+HIGH_RUNTIME_TO_LOADED_DELTA
...
ASSERT dispatch_completed_crystal_message_source_end = sound_block_channel
COPYBLOCK dispatch_completed_crystal_message_source, dispatch_completed_crystal_message_source_end, dispatch_completed_crystal_message+HIGH_RUNTIME_TO_LOADED_DELTA
...
.golden_dragon_inline_message
    EQUB VDU_TEXT_AT, GOLDEN_DRAGON_THE_CURSOR_X, GOLDEN_DRAGON_THE_CURSOR_Y
    EQUS "THE"
    EQUB VDU_TEXT_AT, GOLDEN_DRAGON_NAME_CURSOR_X, GOLDEN_DRAGON_GOLDEN_CURSOR_Y
    EQUS "GOLDEN"
    EQUB VDU_TEXT_AT, GOLDEN_DRAGON_NAME_CURSOR_X, GOLDEN_DRAGON_DRAGON_CURSOR_Y
    EQUS "DRAGON"
    EQUB VDU_TEXT_AT, GOLDEN_DRAGON_LEFT_ORNAMENT_X, GOLDEN_DRAGON_ORNAMENT_Y
    EQUB GOLDEN_DRAGON_ORNAMENT_CHARACTER, ASCII_SPACE, GOLDEN_DRAGON_ORNAMENT_CHARACTER
    EQUB VDU_TEXT_AT, GOLDEN_DRAGON_RIGHT_ORNAMENT_X, GOLDEN_DRAGON_ORNAMENT_Y
    EQUB GOLDEN_DRAGON_ORNAMENT_CHARACTER, ASCII_SPACE, GOLDEN_DRAGON_ORNAMENT_CHARACTER
    EQUB INLINE_VDU_STREAM_END
...
ASSERT remaining_status_icon_graphic = status_icon_graphics + STATUS_GRAPHIC_REMAINING_ICON*GRAPHIC_RECORD_BYTES
ASSERT collected_status_icon_graphic = status_icon_graphics + STATUS_GRAPHIC_COLLECTED_ICON*GRAPHIC_RECORD_BYTES
ASSERT initial_status_marker_graphic = status_icon_graphics + STATUS_GRAPHIC_INITIAL_MARKER*GRAPHIC_RECORD_BYTES
ASSERT blank_status_icon_graphic = status_icon_graphics + STATUS_GRAPHIC_BLANK_ICON*GRAPHIC_RECORD_BYTES
...
COPYBLOCK status_icon_graphics_source, unused_status_figure_graphics_source_end, status_icon_graphics+LOW_RUNTIME_TO_LOADED_DELTA
...
COPYBLOCK relocated_game_entry_source, relocated_game_entry_source_end, relocated_game_entry+LOW_RUNTIME_TO_LOADED_DELTA
...
ASSERT item_slot_label_table_source_end = ITEM_LABEL_TABLE_PADDING_ADDRESS
COPYBLOCK item_slot_label_table_source, item_slot_label_table_source_end, item_slot_label_table+LOW_RUNTIME_TO_LOADED_DELTA
...
ASSERT item_label_table_padding_source = ITEM_LABEL_TABLE_PADDING_ADDRESS
ASSERT item_label_table_padding_source_end = music_tune_sequence
COPYBLOCK item_label_table_padding_source, item_label_table_padding_source_end, ITEM_LABEL_TABLE_PADDING_ADDRESS+LOW_RUNTIME_TO_LOADED_DELTA
...
COPYBLOCK music_tune_sequence_source, music_tune_sequence_source_end, music_tune_sequence+LOW_RUNTIME_TO_LOADED_DELTA
...
ASSERT lift_and_hazard_graphic_descriptor_source_end = cross_room_robot_ghost_frame_pointer_table
COPYBLOCK lift_and_hazard_graphic_descriptor_source, lift_and_hazard_graphic_descriptor_source_end, lift_and_hazard_graphic_descriptor+LOW_RUNTIME_TO_LOADED_DELTA
...
ASSERT player_graphic_frame_pointer_table_source_end = evntv_read_interval_timer
COPYBLOCK cross_room_robot_ghost_frame_pointer_table_source, player_graphic_frame_pointer_table_source_end, cross_room_robot_ghost_frame_pointer_table+LOW_RUNTIME_TO_LOADED_DELTA
...
COPYBLOCK interval_timer_block_source, interval_timer_block_source_end, interval_timer_block+LOW_RUNTIME_TO_LOADED_DELTA
...
ASSERT room_moving_object_record_table_source_end = initial_item_and_goal_record_table
...
ASSERT room_appearance_table_source_end = room_enemy_record_table
...
ASSERT room_enemy_record_table_source_end = cross_room_robot_ghost_record_table
...
ASSERT cross_room_robot_ghost_record_table_source_end = lift_and_hazard_room_record_table
